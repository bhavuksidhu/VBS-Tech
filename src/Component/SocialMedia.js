  ...
  return (
   ...
   <div className='container'>
    <div className='row'>
        ...
        <div className='added_social'>
        <div className='main_containt_ovrerwrite'>
              <div className='process'>
              <div className="divider-container">
      <span className="divider-text">The fastest path to your customers</span>
      <div className="divider-line" style={{ width: "30%"}}></div>
    </div>
              </div>
   ...
   <section className='container'>
    <div className=''>
        <div className='row'>
           ...
           <div>
            <img src='/Assets/footer/xlife-apts-2048x1267.jpg' />
           </div>
...
<div className='main_class_conts mccts'>
...
<div className='main_class_conts mccts'>
  ...
  <div className='section_conts'>
    ...
    <section className='container add_element_new'>
        <div className='row'>
            <div className='col-lg-6 col-md-12 col-sm-12'>
               <div className=''>
                <div className='elementor-price-table__header'>
<h2 className='elementor-price-table__heading'>
    Starter
</h2>
<span className='elementor-price-table__subheading'>
Media Budgets up to $30,000 </span>
                </div>
                <div className='elementor-price-table__price text-center'>
                    <span className='elementor-price-table__currency'>$</span>
                    <span class="elementor-price-table__integer-part">3,000</span>
                    <span class="elementor-price-table__period ">Monthly</span>
                </div>
                <ul class="elementor-price-table__features-list text-center">
<li class="elementor-repeater-item-764bbc6">
<div class="elementor-price-table__feature-inner">
<i aria-hidden="true" class="far fa-check-circle"></i> <span>
Comprehensive marketing strategy </span>
<hr />
</div>
</li>
<li class="elementor-repeater-item-3c4da66">
<div class="elementor-price-table__feature-inner">
<i aria-hidden="true" class="far fa-check-circle"></i> <span>
...
<li class="elementor-repeater-item-5216d3e">
<div class="elementor-price-table__feature-inner">
<i aria-hidden="true" class="far fa-check-circle"></i> <span>
Expert performance monitoring </span>
<hr />
</div>
</li>
<li class="elementor-repeater-item-98c5756">
<div class="elementor-price-table__feature-inner">
<i aria-hidden="true" class="far fa-check-circle"></i> <span>
Multi-platform advertising </span>
<hr />
</div>
</li>
</ul>
<div class="elementor-price-table__footer mt-4 d-flex justify-content-center align-items-center">
<a class="button_for_start " href="#">
Get Started </a>
...
Get Started </a>
    ...
    <section className='add_element_news'>
    <div className='container'>
    <div className='row'>
